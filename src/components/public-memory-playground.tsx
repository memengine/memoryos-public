    ...
    <section id="playground" className="relative overflow-hidden bg-[#05080d] px-4 py-20 text-white sm:px-6 lg:px-8">
      ...
      <div className="relative mx-auto max-w-7xl">
        ...
        <div className="mt-8 overflow-hidden rounded-[1.75rem] border border-white/10 bg-[#0a1019] shadow-[0_30px_100px_rgba(0,0,0,0.5)]">
          <div className="flex items-center justify-between border-b border-white/10 px-4 py-3 sm:px-5"><div className="flex items-center gap-2"><span className="size-2.5 rounded-full bg-rose-400" /><span className="size-2.5 rounded-full bg-amber-300" /><span className="size-2.5 rounded-full bg-emerald-300" /><span className="ml-3 font-mono text-[11px] text-slate-500">memoryos://playground</span></div><span className="hidden items-center gap-2 text-[10px] font-bold uppercase tracking-wider text-slate-500 sm:flex"><span className="size-1.5 rounded-full bg-emerald-300" /> local simulation</span></div>
          ...
          <div className="grid lg:grid-cols-[220px_1fr]">
            ...
            <div className="grid min-h-[470px] lg:grid-cols-[0.9fr_1.1fr]">
              ...
              <div className="flex min-w-0 flex-col p-5 sm:p-6">
                ...
                <div className="mt-4 flex flex-wrap items-center justify-between gap-3"><span className="text-[10px] font-bold uppercase tracking-wider text-slate-600">response · 187ms simulated</span><div className="flex gap-2"><a href={docsUrl("/quickstart")} target="_blank" rel="noreferrer" className="inline-flex items-center gap-1.5 text-xs font-bold text-slate-400 hover:text-white"><Code2 className="size-3.5" /> Docs</a><Link href={signUpUrl("/")} className="inline-flex items-center gap-1.5 rounded-lg bg-white px-3 py-2 text-xs font-black text-slate-950">Start free <Zap className="size-3.5" /></Link></div></div>
              </div>
            </div>
          </div>
        </div>
