...
function Cursor({ label, className }: { label: string; className: string }) {
  return <span className={cn("absolute z-20 flex items-center gap-1 rounded-full bg-violet-600 px-2.5 py-1 text-[9px] font-bold text-white shadow-xl ring-4 ring-violet-400/25", className)}><CircleDot className="size-3" />{label}</span>;
}
