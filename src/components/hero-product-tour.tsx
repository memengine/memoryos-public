...
const scenes = [
  ...
  { label: "Writers", title: "Connect every production agent safely", detail: "Billing Agent (90) and Support Copilot (50) each receive a dedicated key.", icon: UsersRound, origin: "50% 62%" },
  { label: "Conflicts", title: "Resolve service disagreements automatically", detail: "Authority, evidence, recency, and scope select the trusted claim.", icon: Waypoints, origin: "50% 58%" },
  { label: "Consent", title: "Let the user make the final decision", detail: "Users approve Preferences, Facts, and Goals—and can revoke access later.", icon: ShieldCheck, origin: "32% 70%" },
] as const;
